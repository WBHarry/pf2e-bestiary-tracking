export const rangeOptions = ["extreme", "high", "moderate", "low", "terrible"];

export const savingThrowPerceptionTable = {
...
export const stealthDisableTable = {
